...
`backend/src/tools/index.ts:6@cdb48364`.
...
`frontend/src/hooks/useRealtimeSession.ts:100@491de366`.
...
`frontend/src/hooks/useRealtimeSession.ts:194@42b3788c`. Insert an `await`
...
- Model, voice, instructions and the tool list are fixed server-side at mint
  ...
  `backend/src/routes/realtime.ts:36@5926f442`.
